...
public sealed class DuduMovingObstacle : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // Bind both new prefab instances and moved duplicates to the paper nearest
        // their authored position. Prefab assets cannot store scene references.
        {
            ...
            {
                Vector2 p = candidate.WorldToSurface(placedPosition);
            ...
            if (surface != null)
            {
                ...
                centerPosition = surface.WorldToSurface(placedPosition) + axis * (travelDistance * .5f);
            }
        }
    }
